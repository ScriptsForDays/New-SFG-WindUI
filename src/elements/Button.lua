...
function Element:New(Config)
    ...
    function Button:Set(options)
        ...
        if options.Title ~= nil then
            ...
            Button.ButtonFrame:SetTitle(options.Title)
        end
        
        if options.Desc ~= nil then
            Button.Desc = options.Desc
            Button.ButtonFrame:SetDesc(options.Desc)
        end
        ...
        if options.Icon ~= nil then
            ...
            -- Destroy old icon
            if Button.UIElements.ButtonIcon then
                Button.UIElements.ButtonIcon:Destroy()
            end
