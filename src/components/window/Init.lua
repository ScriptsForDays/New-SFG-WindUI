...
return function(Config)
    ...
    if Window.Folder then
        if not isfolder("SFGUI/" .. Window.Folder) then
            makefolder("SFGUI/" .. Window.Folder)
        end
        if not isfolder("SFGUI/" .. Window.Folder .. "/assets") then
            makefolder("SFGUI/" .. Window.Folder .. "/assets")
        end
