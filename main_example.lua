...
do
    ...
    if ok then
        ...
        WindUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/ScriptsForDays/New-SFG-WindUI/main/dist/main.lua"))()
    end
end
...
do
    local DynamicSection = Window:Section({
        Title = "Dynamic Update Testing",
        Icon = "refresh-cw",
        Desc = "Test dynamic updates for Button, Dropdown, Label, and Paragraph"
    })

    local DynamicTab = DynamicSection:Tab({
        Title = "Dynamic Updates",
        Border = true,
    })

    -- Test Button Dynamic Updates
    DynamicTab:Section({
        Title = "Button Dynamic Updates",
        TextSize = 16,
    })

    local testButton = DynamicTab:Button({
        Title = "Original Button",
        Icon = "mouse-pointer-click",
        Desc = "Click buttons below to update me!",
        Callback = function()
    ...
    DynamicTab:Button({
        ...
        Icon = "edit",
        Callback = function()
            testButton:Set({ Title = "Updated Title! " .. os.date("%H:%M:%S") })
            WindUI:Notify({
                Title = "Button Updated",
                Content = "Button title changed!",
                Icon = "check",
            })
        end
    })
    ...
    DynamicTab:Button({
        Title = "Update Button Icon",
        Icon = "refresh-cw",
        Callback = function()
            local icons = {"bird", "house", "droplet", "mouse", "github"}
            local randomIcon = icons[math.random(1, #icons)]
            testButton:Set({ Icon = randomIcon })
            WindUI:Notify({
                Title = "Icon Updated",
                Content = "Icon changed to: " .. randomIcon,
                Icon = "check",
            })
        end
    })
    ...
    DynamicTab:Button({
        Title = "Update Button Description",
        Icon = "file-text",
        Callback = function()
            testButton:Set({ Desc = "Updated description at " .. os.date("%H:%M:%S") })
            WindUI:Notify({
                Title = "Description Updated",
                Content = "Button description changed!",
                Icon = "check",
            })
        end
    })
    ...
    DynamicTab:Button({
        Title = "Update All Button Properties",
        Icon = "zap",
        Callback = function()
            testButton:Set({
                Title = "Fully Updated Button",
                Icon = "sparkles",
                Desc = "All properties updated at " .. os.date("%H:%M:%S")
            })
            WindUI:Notify({
                Title = "All Properties Updated",
                Content = "Button fully refreshed!",
                Icon = "check",
            })
        end
    })
    ...
    -- Test Dropdown Dynamic Updates
    DynamicTab:Section({
        Title = "Dropdown Dynamic Updates",
        TextSize = 16,
    })

    local testDropdown = DynamicTab:Dropdown({
        Title = "Test Dropdown",
        Desc = "Use buttons below to update me",
    ...
    DynamicTab:Button({
        ...
        Callback = function()
            ...
            testDropdown:Set({ Values = newValues })
            WindUI:Notify({
                Title = "Values Updated",
                Content = "Dropdown options refreshed!",
                Icon = "check",
            })
        end
    })
    ...
    DynamicTab:Button({
        ...
        Icon = "check",
        Callback = function()
            local values = testDropdown.Values or {"Option 1", "Option 2", "Option 3"}
            local randomValue = values[math.random(1, #values)]
            testDropdown:SetValue(randomValue)
            WindUI:Notify({
                Title = "Value Updated",
                Content = "Selected: " .. tostring(randomValue),
                Icon = "check",
            })
        end
    })
    ...
    DynamicTab:Button({
        Title = "Update Dropdown Title & Desc",
        Icon = "edit",
        Callback = function()
            testDropdown:Set({
                Title = "Updated Dropdown " .. os.date("%H:%M:%S"),
                Desc = "This description was updated dynamically!"
            })
            WindUI:Notify({
                Title = "Title/Desc Updated",
                Content = "Dropdown title and description changed!",
                Icon = "check",
            })
        end
    })
    ...
    -- Test Paragraph Dynamic Updates
    DynamicTab:Section({
        Title = "Paragraph Dynamic Updates",
        TextSize = 16,
    })

    local testParagraph = DynamicTab:Paragraph({
        Title = "Original Paragraph Title",
        Desc = "This is the original description. Click buttons below to update me!"
    })
    ...
    DynamicTab:Button({
        ...
        Icon = "type",
        Callback = function()
            testParagraph:Set({ Title = "Updated Title at " .. os.date("%H:%M:%S") })
            WindUI:Notify({
                Title = "Title Updated",
                Content = "Paragraph title changed!",
                Icon = "check",
            })
        end
    })
    ...
    DynamicTab:Button({
        Title = "Update Paragraph Description",
        Icon = "file-text",
        Callback = function()
            ...
            WindUI:Notify({
                Title = "Description Updated",
                Content = "Paragraph description changed!",
                Icon = "check",
            })
        end
    })
    ...
    DynamicTab:Button({
        Title = "Update Paragraph Both",
        Icon = "refresh-cw",
        Callback = function()
            testParagraph:Set({
                Title = "Fully Updated Paragraph",
                Desc = "Both title and description updated at " .. os.date("%H:%M:%S")
            })
            WindUI:Notify({
                Title = "Paragraph Updated",
                Content = "Title and description changed!",
                Icon = "check",
            })
        end
    })
    ...
    -- Test Label Dynamic Updates (using dropdown display label)
    DynamicTab:Section({
        Title = "Label Dynamic Updates",
        TextSize = 16,
    })

    DynamicTab:Paragraph({
        Title = "Note",
        Desc = "Labels are used internally in dropdowns. The dropdown display label updates automatically when you change the dropdown value using :SetValue()."
    })

    DynamicTab:Button({
        Title = "Test Label Update via Dropdown",
        Icon = "tag",
        Callback = function()
            -- Update dropdown value which will update the label
            local currentValue = testDropdown.Value
            local values = testDropdown.Values or {"Option 1", "Option 2", "Option 3"}
            local newValue = values[math.random(1, #values)]
            while newValue == currentValue and #values > 1 do
                newValue = values[math.random(1, #values)]
            end
            testDropdown:SetValue(newValue)
            WindUI:Notify({
                Title = "Label Updated",
                Content = "Dropdown label updated via SetValue: " .. tostring(newValue),
                Icon = "check",
            })
        end
    })
    ...
    -- Info paragraph
    DynamicTab:Paragraph({
        Title = "Dynamic Update Methods",
        Desc = [[
Button:Set({ Title, Icon, Desc, Callback })
Dropdown:Set({ Title, Desc, Value, Values })
Dropdown:SetValue(newValue)
Paragraph:Set({ Title, Desc })
Label:Set({ Text, Icon }) or Label:Set("Text")

All methods support partial updates - only include properties you want to change.
        ]]
    })
end
