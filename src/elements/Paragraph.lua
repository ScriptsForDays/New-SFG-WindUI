...
function Element:New(ElementConfig)
    ...
    function ParagraphModule:Set(options)
        ...
        if options.Title ~= nil then
            ParagraphModule.Title = options.Title
            Paragraph:SetTitle(options.Title)
        end
        
        if options.Desc ~= nil then
            ParagraphModule.Desc = options.Desc
            Paragraph:SetDesc(options.Desc)
        end
    end
